...
mask_grnas_with_guide_umis = Matrix::colSums(guide_umi_mat) > 0
sceptre_object = sceptre::import_data(
  response_matrix = counts_umi_mat[unique(metadata_genes_df$intended_target_gene_symbol), mask_grnas_with_guide_umis,drop=FALSE],
  grna_matrix = guide_umi_mat[, mask_grnas_with_guide_umis],
  grna_target_data_frame = guide_element_map_sceptre[,c(1,2)],
  moi = "high",
  extra_covariates = extra_covariates[mask_grnas_with_guide_umis, ]
)
