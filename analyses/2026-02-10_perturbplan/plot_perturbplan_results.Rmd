...
perturbplan_object_path <- here(
  output_folder,
  "perturbplan_es_15_pval_0.001_both.h5mu"
)
```
...
plot_df = plot_df[mask_unique,]

ggplot(plot_df, aes(x=expression_mean, y=expression_dispersion) ) +
  geom_point() + 
  scale_x_log10() +
  scale_y_log10() + 
  theme_classic(base_size=14)+
  labs(title="SCEPTRE estimated mean and dispersion for readout genes")
  

ggplot(plot_df, aes(x=expression_mean, y=power) ) +
  geom_point() + 
  scale_x_log10() +
  theme_classic(base_size=14)+
  labs(title="SCEPTRE power scores for different ")
