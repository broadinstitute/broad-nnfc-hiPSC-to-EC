...
def _():
    ...
    inner_primer_usage_ec_fnp = "gs://fc-76565551-28c3-4b6d-a048-e272103bcbd1/submissions/intermediates/a5f262a4-2e67-4187-8afa-b4ba48adc7e8/CheckInnerPrimerUsage/4661facf-682a-49f9-87c1-41e051a4e715/call-AnalyzePrimerUsage/rep01_day00_chip_a_batch01_channel01_detailed.tsv"
...
@app.cell
def _(mo):
    mo.md(r"""### Load results and metadata for the hiPSC -> EC""")
    return
...
@app.cell
def _(metadata_genes_ec_fnp, pd):
    metadata_genes_ec = pd.read_csv(metadata_genes_ec_fnp)
    metadata_genes_ec
...
@app.cell
def _(mo):
    mo.md(r"""### Load results and metadata for the WTC11""")
    return
...
@app.cell
def _(mo):
    mo.md(r"""Now let's look at the 23 genes with differen inner primers""")
    return
