...
@app.cell
def _(pd):
    pd.read_csv("results/2025-10-02_ec_multiqc_new_sequencing/metrics_qc/rep01_day00_chip_a_batch01_channel01_metrics_summary.csv").head()
    return


@app.cell
def _():
    out_path = "results/2025-10-02_ec_multiqc_new_sequencing/metrics_qc_custom_mqc.tsv"
    return (out_path,)
...
def _(glob, os, out_path, pd):
    ...
    file_paths = glob.glob("results/2025-10-02_ec_multiqc_new_sequencing/metrics_qc/*_metrics_summary.csv")
